...
1. Pode ser utilizada qualquer linguagem.
2. Utilizar somente bibliotecas padrão da linguagem escolhida.
3. Testes unitários são opcionais.
4. A interface do sistema construído deve ser do tipo console.
5. O código deve ser executável.
...
O Problema: Senhor Eduardo é proprietário de um canil em Belo Horizonte, ele trabalha com diversas raças, pequenas e grandes. Eduardo gosta que seus cães estejam sempre arrumados, felizes e cheirosos.
...
Entrada:<data_do_banho> <quantidade de cães pequenos> <quantidade cães grandes> Exemplo: 03/08/2018 3 5
